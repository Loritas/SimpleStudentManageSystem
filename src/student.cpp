 ...
 * @LastEditTime: 2022-06-09 22:24:24
...
void Student::setCppScore(std::string score)
{
    this->cppScore = atof(score.c_str());
}

void Student::setJavaScore(std::string score)
{
    this->javaScore = atof(score.c_str());
}